...
inline XMMATRIX XM_CALLCONV XMMatrixMultiply_AVX2(FXMMATRIX M1, CXMMATRIX M2) noexcept {
    __m256 t0 = _mm256_set_m128(M1.r[1], M1.r[0]);
    __m256 t1 = _mm256_set_m128(M1.r[3], M1.r[2]);
    __m256 u0 = _mm256_set_m128(M2.r[1], M2.r[0]);
    __m256 u1 = _mm256_set_m128(M2.r[3], M2.r[2]);

    __m256 a0, a1, b0, c0, c1;
    ...
    #define MULTIPLY_COL(i, perm_mask)                                      \
        a0 = _mm256_shuffle_ps(t0, t0, _MM_SHUFFLE(i, i, i, i));             \
        a1 = _mm256_shuffle_ps(t1, t1, _MM_SHUFFLE(i, i, i, i));             \
        b0 = _mm256_permute2f128_ps((i < 2) ? u0 : u1, (i < 2) ? u0 : u1, perm_mask); \
    ...
    return {
        ...
        _mm256_extractf128_ps(c0, 1),
        _mm256_castps256_ps128(c1),
        _mm256_extractf128_ps(c1, 1)
    };
}
